...
class Yolo11nDetector(AbstractObjectDetector):
    ...
    def save_result(self, image_path, bboxes, map, camera, index):
        ...
        # === 保存先のディレクトリを作成 ===
        output_image_dir = f"C:\CARLA_Latest\WindowsNoEditor\ObjectDetection/output/{map}/images/yolov11n_results/{camera}"
        output_label_dir = f"C:\CARLA_Latest\WindowsNoEditor\ObjectDetection/output/{map}/labels/yolov11n_results/{camera}"
